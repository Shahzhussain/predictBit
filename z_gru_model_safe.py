...
BASE = "."
RESULTS_DIR = os.path.join(BASE, "results", "gru")
...
ckpt = ModelCheckpoint(os.path.join(RESULTS_DIR, "best_gru.h5"), monitor="val_loss", save_best_only=True, verbose=1)
...
best_path = os.path.join(RESULTS_DIR, "best_gru.h5")
...
print("GRU results saved to", RESULTS_DIR)
print(rep)
model.save(os.path.join(RESULTS_DIR, "final_gru_model"))
