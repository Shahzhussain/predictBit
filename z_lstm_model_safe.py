...
BASE = "."
RESULTS_DIR = os.path.join(BASE, "results", "lstm")
...
# Callbacks
ckpt = ModelCheckpoint(os.path.join(RESULTS_DIR, "best_lstm.h5"), monitor="val_loss", save_best_only=True, verbose=1)
...
# Load best
best_path = os.path.join(RESULTS_DIR, "best_lstm.h5")
...
print("LSTM results saved to", RESULTS_DIR)
print(rep)
# Save final model copy
model.save(os.path.join(RESULTS_DIR, "final_lstm_model"))
